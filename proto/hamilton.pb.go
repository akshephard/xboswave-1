...
func (*HamiltonData) Descriptor() ([]byte, []int) {
	return fileDescriptor_hamilton_4c956fcfad6b5ec7, []int{0}
}
...
func (*Hamilton3C) Descriptor() ([]byte, []int) {
	return fileDescriptor_hamilton_4c956fcfad6b5ec7, []int{1}
}
...
func (*Hamilton330) Descriptor() ([]byte, []int) {
	return fileDescriptor_hamilton_4c956fcfad6b5ec7, []int{2}
}
...
func (*HamiltonBRLinkStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_hamilton_4c956fcfad6b5ec7, []int{3}
}
...
func (*HamiltonBRMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_hamilton_4c956fcfad6b5ec7, []int{4}
}
...
func init() { proto.RegisterFile("hamilton.proto", fileDescriptor_hamilton_4c956fcfad6b5ec7) }

var fileDescriptor_hamilton_4c956fcfad6b5ec7 = []byte{
