...
type XBOSIoTDeviceState struct {
	...
	Wattnode             *WattnodeState            `protobuf:"bytes,12,opt,name=wattnode,proto3" json:"wattnode,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                  `json:"-"`
	XXX_unrecognized     []byte                    `json:"-"`
	XXX_sizecache        int32                     `json:"-"`
}
...
func (m *XBOSIoTDeviceState) GetWattnode() *WattnodeState {
	if m != nil {
		return m.Wattnode
	}
	return nil
...
var fileDescriptor_1804728d01c3c43d = []byte{
	...
	,
}
