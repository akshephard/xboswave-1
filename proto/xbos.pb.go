...
func (*XBOS) Descriptor() ([]byte, []int) {
	return fileDescriptor_xbos_a1af713f0065f125, []int{0}
}
...
func init() { proto.RegisterFile("xbos.proto", fileDescriptor_xbos_a1af713f0065f125) }

var fileDescriptor_xbos_a1af713f0065f125 = []byte{
