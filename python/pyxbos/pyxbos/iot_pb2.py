...
from . import rtac_pb2 as rtac__pb2
...
_XBOSIOTDEVICESTATE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='rtac', full_name='xbospb.XBOSIoTDeviceState.rtac', index=10,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='wattnode', full_name='xbospb.XBOSIoTDeviceState.wattnode', index=11,
...
_XBOSIOTDEVICESTATE.fields_by_name['rtac'].message_type = rtac__pb2._RTAC
_XBOSIOTDEVICESTATE.fields_by_name['wattnode'].message_type = wattnode__pb2._WATTNODESTATE
