...
_XBOSIOTDEVICESTATE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='wattnode_state', full_name='xbospb.XBOSIoTDeviceState.wattnode_state', index=10,
...
_XBOSIOTDEVICESTATE.fields_by_name['wattnode_state'].message_type = wattnode__pb2._WATTNODESTATE
