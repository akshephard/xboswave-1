...
if (( $# == 0 )); then
    ...
    wv inspect $ENTITY
    echo "Did inspection"
    wv rtgrant --subject $ENTITY -e 3y --attester $WAVE_DEFAULT_ENTITY --indirections 0 wavemq:publish,subscribe@solarplus/*
    ...
    wv rtprove --subject $ENTITY -o driverproof.pem wavemq:publish,subscribe@solarplus/*
    echo "Did proof"
