        ...
        msg = xbos_pb2.XBOS(
            XBOSIoTDeviceState = iot_pb2.XBOSIoTDeviceState(
                ...
                parker_state = parker_pb2.ParkerState(
                    ...
                    door_switch_input_status  =   types.Bool(value=output.get('door_switch_input_status',None)),
                    multipurpose_input_status  =   types.Bool(value=output.get('multipurpose_input_status',None)),
                    compressor_status  =   types.Bool(value=output.get('compressor_status',None)),
                    output_defrost_status  =   types.Bool(value=output.get('output_defrost_status',None)),
                    fans_status  =   types.Bool(value=output.get('fans_status',None)),
                    output_k4_status  =   types.Bool(value=output.get('output_k4_status',None)),
                    ...
                    probe1_failure_alarm  =   types.Bool(value=output.get('probe1_failure_alarm',None)),
                    probe2_failure_alarm  =   types.Bool(value=output.get('probe2_failure_alarm',None)),
                    probe3_failure_alarm  =   types.Bool(value=output.get('probe3_failure_alarm',None)),
                    minimum_temperature_alarm  =   types.Bool(value=output.get('minimum_temperature_alarm',None)),
                    maximum_temperture_alarm  =   types.Bool(value=output.get('maximum_temperture_alarm',None)),
                    condensor_temperature_failure_alarm  =   types.Bool(value=output.get('condensor_temperature_failure_alarm',None)),
                    condensor_pre_alarm  =   types.Bool(value=output.get('condensor_pre_alarm',None)),
                    door_alarm  =   types.Bool(value=output.get('door_alarm',None)),
                    multipurpose_input_alarm  =   types.Bool(value=output.get('multipurpose_input_alarm',None)),
                    compressor_blocked_alarm  =   types.Bool(value=output.get('compressor_blocked_alarm',None)),
                    power_failure_alarm  =   types.Bool(value=output.get('power_failure_alarm',None)),
                    rtc_error_alarm  =   types.Bool(value=output.get('rtc_error_alarm',None)),
                    energy_saving_regulator_flag  =   types.Bool(value=output.get('energy_saving_regulator_flag',None)),
                    energy_saving_real_time_regulator_flag  =   types.Bool(value=output.get('energy_saving_real_time_regulator_flag',None)),
                    service_request_regulator_flag  =   types.Bool(value=output.get('service_request_regulator_flag',None)),
                    on_standby_regulator_flag  =   types.Bool(value=output.get('on_standby_regulator_flag',None)),
                    new_alarm_to_read_regulator_flag  =   types.Bool(value=output.get('new_alarm_to_read_regulator_flag',None)),
                    ...
                    energy_saving_status  =   types.Bool(value=output.get('energy_saving_status',None)),
                    service_request_status  =   types.Bool(value=output.get('service_request_status',None)),
                    resistors_activated_by_aux_key_status  =   types.Bool(value=output.get('resistors_activated_by_aux_key_status',None)),
                    evaporator_valve_state  =   types.Bool(value=output.get('evaporator_valve_state',None)),
                    output_defrost_state  =   types.Bool(value=output.get('output_defrost_state',None)),
                    output_lux_state  =   types.Bool(value=output.get('output_lux_state',None)),
                    output_aux_state  =   types.Bool(value=output.get('output_aux_state',None)),
                    resistors_state  =   types.Bool(value=output.get('resistors_state',None)),
                    output_alarm_state  =   types.Bool(value=output.get('output_alarm_state',None)),
                    second_compressor_state  =   types.Bool(value=output.get('second_compressor_state',None)),
